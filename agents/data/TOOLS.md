...
```bash
gh issue list --repo Liboudou/<repo> --label data
gh pr create --repo Liboudou/<repo> --title "data: ..." --body "..."
```

**MCP GitHub** disponible pour lire les fichiers de migration directement depuis les repos.
